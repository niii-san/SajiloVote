    ...
    <div className="min-h-[800px] ">
      <div className="w-[1000px] h-[600px] mx-auto mt-36 flex justify-start">
        ...
        <div className="w-[45%] rounded-r-md py-5 bg-white ">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-12 px-5">
            <div id="names" className="flex mx-auto gap-2 justify-between  ">
            ...
            <div id="otherFields" className="mx-auto">
              ...
              {resErr && (
                <p className="h-[14px] text-red-600 text-sm">{resErr}</p>
              )}
            </div>
