...
import { Button, ConfirmJoinModal, Loader } from "../../../../components";
...
function RouteComponent() {
    ...
    return (
        <>
            {confirmJoinModal && (
                <ConfirmJoinModal
                    setModalFn={setConfirmJoinModal}
                    onConfirmFn={handleConfirm}
                    loading={confirmLoading}
                    resErr={confirmResErr}
                />
            )}
